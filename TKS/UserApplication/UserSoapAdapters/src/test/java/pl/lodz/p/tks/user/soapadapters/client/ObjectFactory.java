 ...
 * generated in the pl.lodz.p.tks.user.soapadapters.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddUser_QNAME = new QName("http://adapters.soapadapters.user.tks.p.lodz.pl/", "addUser");
    private final static QName _AddUserResponse_QNAME = new QName("http://adapters.soapadapters.user.tks.p.lodz.pl/", "addUserResponse");
    private final static QName _GetName_QNAME = new QName("http://adapters.soapadapters.user.tks.p.lodz.pl/", "getName");
    private final static QName _GetNameResponse_QNAME = new QName("http://adapters.soapadapters.user.tks.p.lodz.pl/", "getNameResponse");
    private final static QName _GetUserById_QNAME = new QName("http://adapters.soapadapters.user.tks.p.lodz.pl/", "getUserById");
    private final static QName _GetUserByIdResponse_QNAME = new QName("http://adapters.soapadapters.user.tks.p.lodz.pl/", "getUserByIdResponse");
    private final static QName _GetUserByUsername_QNAME = new QName("http://adapters.soapadapters.user.tks.p.lodz.pl/", "getUserByUsername");
    private final static QName _GetUserByUsernameResponse_QNAME = new QName("http://adapters.soapadapters.user.tks.p.lodz.pl/", "getUserByUsernameResponse");
    private final static QName _GetUsers_QNAME = new QName("http://adapters.soapadapters.user.tks.p.lodz.pl/", "getUsers");
    private final static QName _GetUsersResponse_QNAME = new QName("http://adapters.soapadapters.user.tks.p.lodz.pl/", "getUsersResponse");
    private final static QName _UpdateUserById_QNAME = new QName("http://adapters.soapadapters.user.tks.p.lodz.pl/", "updateUserById");
    private final static QName _UpdateUserByIdResponse_QNAME = new QName("http://adapters.soapadapters.user.tks.p.lodz.pl/", "updateUserByIdResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pl.lodz.p.tks.user.soapadapters.client
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://adapters.soapadapters.user.tks.p.lodz.pl/", name = "addUser")
     ...
     */
    @XmlElementDecl(namespace = "http://adapters.soapadapters.user.tks.p.lodz.pl/", name = "addUserResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://adapters.soapadapters.user.tks.p.lodz.pl/", name = "getName")
     ...
     */
    @XmlElementDecl(namespace = "http://adapters.soapadapters.user.tks.p.lodz.pl/", name = "getNameResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://adapters.soapadapters.user.tks.p.lodz.pl/", name = "getUserById")
     ...
     */
    @XmlElementDecl(namespace = "http://adapters.soapadapters.user.tks.p.lodz.pl/", name = "getUserByIdResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://adapters.soapadapters.user.tks.p.lodz.pl/", name = "getUserByUsername")
     ...
     */
    @XmlElementDecl(namespace = "http://adapters.soapadapters.user.tks.p.lodz.pl/", name = "getUserByUsernameResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://adapters.soapadapters.user.tks.p.lodz.pl/", name = "getUsers")
     ...
     */
    @XmlElementDecl(namespace = "http://adapters.soapadapters.user.tks.p.lodz.pl/", name = "getUsersResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://adapters.soapadapters.user.tks.p.lodz.pl/", name = "updateUserById")
     ...
     */
    @XmlElementDecl(namespace = "http://adapters.soapadapters.user.tks.p.lodz.pl/", name = "updateUserByIdResponse")
