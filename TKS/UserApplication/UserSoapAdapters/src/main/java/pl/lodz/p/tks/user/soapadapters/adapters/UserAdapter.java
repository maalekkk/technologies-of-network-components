...
import pl.lodz.p.tks.user.soapadapters.adapters.converters.UserConverter;
import pl.lodz.p.tks.user.soapadapters.data.user.UserSoap;
...
@Named
@ApplicationScoped
@WebService(endpointInterface = "pl.lodz.p.tks.user.soapadapters.adapters.IUserAdapter")
