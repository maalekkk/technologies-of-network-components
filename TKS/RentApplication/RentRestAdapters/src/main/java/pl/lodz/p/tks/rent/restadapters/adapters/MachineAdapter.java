...
import pl.lodz.p.tks.rent.restadapters.adapters.converters.MachineConverter;
...
public class MachineAdapter {
    ...
    @PUT
    @Path("/gaming/{id}")
    public Response updateMachineGaming(
            @PathParam("id") UUID machineId,
    ...
    @PUT
    @Path("/workstation/{id}")
    public Response updateMachineWorkstation(
            @PathParam("id") UUID machineId,
