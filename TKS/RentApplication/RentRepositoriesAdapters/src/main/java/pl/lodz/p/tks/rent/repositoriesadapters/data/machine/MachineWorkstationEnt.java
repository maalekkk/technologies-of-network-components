...
public class MachineWorkstationEnt extends MachineEnt {
    @Min(1)
    @NotNull
    ...
    public MachineWorkstationEnt() {
    }

    public MachineWorkstationEnt(String name, Integer cores, Integer ramSize, Integer hddSize, Integer ssdSize, Integer netCards, boolean raidSupport) {
